...
export function VariableTooltip({
  ...
  return (
    <div
      className="fixed z-[60] bg-gray-900 text-white px-3 py-2 rounded-lg shadow-lg max-w-sm"
      style={{
        left: `${x}px`,
        top: `${y}px`,
      }}
    >
      <div className="text-xs font-medium text-gray-300 mb-1">Variable</div>
      ...
      {environmentName && (
        <>
          <div className="text-xs text-gray-300 mt-2 mb-1">Environment</div>
