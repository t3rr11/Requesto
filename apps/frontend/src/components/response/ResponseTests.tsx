...
export function ResponseTests({ testResults }: Readonly<ResponseTestsProps>) {
  if (!testResults || testResults.length === 0) {
    return (
      <div className="py-4 px-5 text-sm text-gray-600 dark:text-gray-400 overflow-y-auto h-full">
