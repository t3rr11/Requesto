  ...
  return (
    <>
      <PageShell
        ...
        title="OAuth 2.0 Configurations"
        subtitle="Manage OAuth authentication providers for secure API access"
        actions={[
          { label: 'New Configuration', icon: <Plus className="w-4 h-4" />, onClick: handleCreateNew },
        ]}
        sidebar={
          <OAuthConfigList
            configs={configs}
      ...
      >
        {selectedConfig ? (
          ...
          <EmptyState
            ...
            description="Create your first OAuth configuration to authenticate with secure APIs using industry-standard OAuth 2.0"
            action={{ label: 'Create OAuth Configuration', icon: <Plus className="w-4 h-4" />, onClick: handleCreateNew }}
          />
        )}
      </PageShell>
