...
export const BatchHeadersForm: React.FC<BatchHeadersFormProps> = ({
  onImport,
  onCancel,
}) => {
  ...
  const parseHeaders = (text: string, selectedFormat: string) => {
    ...
    try {
      ...
      if (
        selectedFormat === "json" ||
        (selectedFormat === "auto" && text.trim().startsWith("{"))
      ) {
...
-H "Accept: application/json"`,
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-500">Paste multiple headers at once</p>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <Button
            ...
            variant={format === "auto" ? "primary" : "secondary"}
            size="sm"
          >
            Auto-detect
          </Button>
